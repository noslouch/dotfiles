" Capistrano, named after the Mary Heilmann piece
" local syntax file - set colors on a per-machine basis:
" vim: tw=0 ts=4 sw=4
" Vim color file
" Maintainer: Gabriel Herrera
...
let g:colors_name = "capistrano"
hi Normal   ctermfg=39 ctermbg=black guifg=#6666CC guibg=#000011
hi NonText  ctermfg=DarkGray ctermbg=black guifg=#555555 guibg=#000000
hi Comment term=bold ctermfg=black ctermbg=33 guifg=#555555 gui=italic
hi Constant term=bold  gui=bold ctermfg=DarkRed ctermbg=black guifg=#880000
hi Identifer term=bold ctermbg=black ctermfg=33 guifg=#99AAAA 
hi Boolean  ctermfg=Red ctermbg=black guifg=LightRed
hi String term=bold ctermfg=27 ctermbg=black guifg=#FF0000
...
hi Delimiter term=bold ctermfg=Red ctermbg=Black guifg=#33AAFF gui=bold
hi Debug    ctermbg=LightBlue guibg=#9999FF ctermfg=black guifg=Black gui=italic
hi Statement term=bold ctermfg=69 ctermbg=black gui=bold    guifg=#FFFF66
...
hi Label ctermfg=25 ctermbg=black guifg=#FFFF99 gui=bold
...
hi Macro  term=bold gui=bold    ctermbg=black ctermfg=LightCyan guifg=#0077FF0
hi PreCondit  term=bold gui=bold    ctermbg=Red ctermfg=LightCyan guifg=#0066FF
...
hi Function ctermfg=93 ctermbg=black guifg=#22AADD
hi javaScriptBraces ctermfg=201
hi javaScriptParens ctermfg=93
hi javaScriptNumber ctermfg=123
hi Repeat   ctermfg=White ctermbg=black guifg=#BBBBFF gui=bold
hi Conditional  gui=Bold ctermbg=black term=Bold guifg=#FFCCEE ctermfg=54
...
hi Todo term=standout ctermbg=123 ctermfg=black guifg=Blue guibg=Yellow
hi LineNr ctermfg=6 ctermbg=17 guifg=#333333 guibg=#050505 gui=italic
hi Tag ctermfg=Yellow ctermbg=black guifg=#FFFF00 gui=italic
hi Cursor term=bold ctermbg=154 ctermfg=black guibg=#999900 guifg=black 
...
hi VertSplit    gui=none    guifg=#444444   guibg=#333333   ctermfg=17 ctermbg=17
...
hi Title        guifg=DarkGray ctermbg=Black ctermfg=white guifg=Gray gui=bold    cterm=bold
